...
parser.add_argument("-d","--dir", dest="dir", required=True, help="The directory monitored (you *need* to provide this parameter)")
...
parser.add_argument("--schedule", dest="daySchedule", default="",  help="Defines a series of times to run the script. The argument is a continuous string with no spaces, and times are comma-separated given in this form:  HH:MM,HH:MM,.. ")
